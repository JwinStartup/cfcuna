...
export default function NOUVEAU_SID() {
  return (
   ...
   <div className='flex flex-col  justify-between items-center px-4'>
       <div className='flex items-center space-y-5'>
           ...
           <div className='flex flex-col items-start ml-3 mb-3'>
               ...
               <p className='text-base text-center text-violet-600 font-medium '>Preinscription en Licence 3</p>
           </div>
       </div>
       <button className='p-2 bg-violet-600 text-white text-lg font-medium tracking-widest rounded-md w-28'>Voir</button>
