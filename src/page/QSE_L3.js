...
import SousMenuQSE from '../component/SousMenuQSE.js'
    ...
    switch (tag) {
        ...
        case 'cout':
          return( <div> <p className='text-lg text-gray-600 font-normal m-2 p-2'>
              La Licence coûte <span className='text-black'> 880 000 F</span></p>
              ...
              <thead>
                ...
                <tbody>
                     ...
                     <td class="border border-slate-300 w-72 text-center font-bold">30 000 F CFA</td>
                      </tr>
                      <tr>
                        <td class="border border-slate-300 w-72 text-center">Droit de scolarité </td>
                        <td class="border border-slate-300 w-72 text-center font-bold">850 000 F CFA</td>
                        </tr>
                </tbody>
              </table>
                ...
                return( <div> <p className='text-lg text-gray-600 font-normal m-2 p-2'>
                    ...
                    <thead>
                      ...
                      <tbody>
                            ...
                            <tr><td class="border border-slate-300 w-72 text-center ">1ere versement</td><td class="border border-slate-300 w-72 text-center font-bold">330 000 F (à payer à l’inscription)</td></tr>
                           ...
                           <tr><td class="border border-slate-300 w-72 text-center ">4éme versement</td><td class="border border-slate-300 w-72 text-center font-bold">150 000 F</td></tr>
...
export default function QSE() {
  ...
  return (
    <div >
     ...
     <path d="M172.99 172.752C34.2967 130.304 -7.07007 94.1942 0.953251 2.09143V0H929V581C769.989 572.382 639.56 543.307 606.356 478.938C560.807 390.636 526.261 357.261 441.463 339.23C320.123 328.821 272.374 313.17 234.9 263.102C212.95 216.501 199.723 195.054 172.99 172.752Z" fill="green" fill-opacity="0.2"/>
    </svg>
  </div>
      <Header/>
      <div className='flex flex-row justify-between flex-1'>
       <div className='w-[20%] '> <SousMenuQSE/></div>
      ...
      <li id='of'  className='font-medium text-2xl tracking-wider py-3 px-1 '>Objectifs de la formation</li>
            <div className='mb-5'>
                ...
                La Licence 3 Professionnelle de Management Intégré Qualité – Sécurité - Environnement a pour objectif de fournir au milieu industriel des cadres moyens polyvalents (Assistants techniques) dans le domaine du contrôle et du management de la Qualité (référentiel ISO 9001_2015), de l’Environnement (référentiel ISO 14001_2015) et de la Sécurité (référentiel OHSAS 18001) avec de solides connaissances des aspects réglementaires, de la sécurité et de la démarche qualité dans les métiers de l’agroalimentaire, de l’environnement et de la santé. Ces normes sont complétées par le Développement Durable, le HACCP, et la Directive REACH.
                </p>
                </div>
                <li id='mr'  className='font-medium text-2xl tracking-wider py-3 px-1 '>Modalités de recrutement</li>
            <div className='mb-5'>
                <p className='text-lg text-gray-600 font-normal'>
                Titulaires d'un diplôme de niveau L2 (DUT, BTS ou L2 scientifiques d'universités). Une autre possibilité de recrutement peut se faire par validation d'acquis d'expérience (VAE) ou par validation d'études supérieures (VES) pour les salariés. 
                <br/>
           ...
           <li id='deb'  className='font-medium text-2xl tracking-wider py-3 px-1 '>Débouchés</li>
               <div className='mb-5'>
                <p className='text-lg text-gray-600 font-normal'>
                Comme la qualité, la sécurité et l'environnement sont essentielles dans le milieu industriel, l'insertion professionnelle est très aisée pour les personnes titulaires de la Licence Professionnelle QSE. Les diplômés pourront exercer comme :
                
                <dd className='indent-3 space-y-2'>
                    <dt>- Animateur Qualité ;</dt>
                    <dt>- Techniciens de production et de contrôle qualité ; </dt>
                    <dt>- Responsable qualité ;</dt>
                    <dt>- Responsable de laboratoire ; </dt>
                    <dt>- Responsable de production ;</dt>
                    <dt>- Responsable des services techniques ;</dt>
                    <dt>- Responsable sécurité ;</dt>
                    <dt>- Responsable environnement ;</dt>
                    <dt>- Techniciens en R&D (Nouveau produits, Amélioration des procédés, ...) ; </dt>
                    <dt>- etc. </dt>
                </dd></p>
                </div>
        </ul>
         <ul className='flex w-[90%] justify-between items-center mx-6 '>
           ...
           <div id='pre'> <QSE_SWITCH tag={tag} /></div>
      </div>
      <div className='w-[20%] '>
      <SurPage colorTg={'text-green-500'} rub={rub} />
      </div> </div>
    </div>
  )
}
