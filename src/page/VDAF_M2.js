...
<path d="M172.99 172.752C34.2967 130.304 -7.07007 94.1942 0.953251 2.09143V0H929V581C769.989 572.382 639.56 543.307 606.356 478.938C560.807 390.636 526.261 357.261 441.463 339.23C320.123 328.821 272.374 313.17 234.9 263.102C212.95 216.501 199.723 195.054 172.99 172.752Z" fill="rgb(133 77 14)" fill-opacity="0.2"/>
      ...
      <div className='flex flex-row justify-between flex-1'>
       <div className='w-[20%] '> <SousMenuVDAF/></div>
      ...
      <li id='mr'  className='font-medium text-2xl tracking-wider py-3 px-1 '>Modalités de recrutement</li>
           ...
           <li id='deb'  className='font-medium text-2xl tracking-wider py-3 px-1 '>Débouchés</li>
               <div className='mb-5'>
                <p className='text-lg text-gray-600 font-normal'>
                Comme la qualité, la sécurité et l'environnement sont essentielles dans le milieu industriel, l'insertion professionnelle est très aisée pour les personnes titulaires de la Licence Professionnelle VDAF. Les diplômés pourront exercer comme :
         ...
         <ul className='flex w-[90%] justify-between items-center mx-6 '>
           ...
           <div id='pre'> <VDAF_SWITCH tag={tag} /></div>
      </div>
      <div className='w-[20%] '>
